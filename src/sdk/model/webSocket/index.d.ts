...
export interface WeexWebSocketModule extends WeexModule {
     ...
     */
    readonly onopen: (options: object) => void;

    /**
     *消息事件的监听器
     * @param {WeexWebSocketMessage} options  服务器返回的消息对象
     */
    readonly  onmessage: (options: WeexWebSocketMessage) => void;

    /**
     * 关闭事件的监听器
     * @param {WeexWebSocketCloseMessge} options  监听器接收到的对象
     */
    readonly  onclose: (options: WeexWebSocketCloseMessge) => void;

    /**
     * 错误事件的监听器
     * @param {WeexWebSocketMessage} options 错误信息的事件
     */
    readonly onerror: (options: WeexWebSocketMessage) => void;
}
